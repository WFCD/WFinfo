...
namespace WFInfo
{
    ...
    public partial class Login : Window
    {
        ...
        private void Offline_OnMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            Main.dataBase.setStatus("offline");
        }

        private void Online_OnMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            Main.dataBase.setStatus("online");
        }

        private void Ingame_OnMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
